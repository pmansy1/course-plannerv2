...
from .views import recommend_courses, get_available_courses, find_path, get_course_by_title, get_all_courses




urlpatterns = [
    path('recommend_courses/', recommend_courses, name='recommend_courses'),
